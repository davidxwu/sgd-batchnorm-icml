...
from torchvision.models import (ResNet18_Weights, VGG16_BN_Weights, resnet18,
                                vgg16_bn)
...
parser.add_argument(
    "--num_classes", default=10, type=int, help="How many classes to use in CIFAR10"
)
parser.add_argument(
    "--seed", default=-1, type=int, help="seed for randomness (nondet if not included)"
)
parser.add_argument(
    "--eval_type", default="GD", type=str, help="Whether to use GD/SS risk to eval"
)
args: Namespace = parser.parse_args()

writer = SummaryWriter(
    comment=f"cifar10_shuffling_{args.sampling}_lr_{args.lr}_epoch_{args.epoch}_width_{args.width}_bsize_{args.bsize}_momen_{args.momen}_ema_{args.ema}_model_{args.model}_eval_type_{args.eval_type}_{args.suffix}"
)
