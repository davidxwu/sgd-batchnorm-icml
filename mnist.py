...
parser.add_argument('--num_classes', default=10, type=int, help='How many classes to use in MNIST')
args: Namespace = parser.parse_args()

writer = SummaryWriter(comment=f'_mnist_shuffling_{args.sampling}_lr_{args.lr}_epoch_{args.epoch}_width_{args.width}_bsize_{args.bsize}_momen_{args.momen}_ema_{args.ema}_model_{args.model}_{args.suffix}')
